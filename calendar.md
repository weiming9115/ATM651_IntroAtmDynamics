...
| 5 |Cover the assigned **reading through 7.2.6**, & review **students answers to 7.5 a-k**. Collect (midnight) **HW1 ASSIGNMENT: Show (7.2) for a circular area using (7.4), and do problems 7.6-7.10**. Hand out review for Unit 1 exam. | Vorticity. Cover the assigned **reading: section 7.2.9.** & review **students' prepared, time-stamped questions (1 per student)** on vorticity films [(parts 1&2) here](http://web.mit.edu/hml/ncfmf.html). Assign vortex-interactions lab (IDV views captured in .ipynb). |
| 6 | ***Unit 1 in-class exam: vocabulary, math tools, kinematics*** | View students' **vorticity interactions lab notebooks.** |
| 7 | Discuss the assigned **reading: section 7.2.7 (thermal wind)** and **elicit student answers to 7.5 l-z minus unready ones like r,s,v**  | Collect (midnight) **HW2 ASSIGNMENT: Thermal wind problems 7.x** |
